...
// import { CustomButton, Section, CustomInput } from '../../components'
// import { AppDispatch } from '../../redux/store'
// import { QuestionAnswerOptionT, QuestionT } from '../../types/types'

// export const Questions = () => {
//   const dispatch = useDispatch<AppDispatch>()
//   const score = useSelector(selectScore)
//   const questionsDB: QuestionT[] = useSelector(selectQuestions)
//   const navigate = useNavigate()

//   const [currentQuestionIndex, setCurrentQuestionIndex] = useState<number>(0)
//   const [selectedAnswers, setSelectedAnswers] = useState<
//     QuestionAnswerOptionT[]
//   >([])
...
//   const handleAnswerClick = (optionIndex: QuestionAnswerOptionT) => {
...
//     const isCorrect: boolean = selectedAnswers.every(
...
//         </Heading>
//         <List spacing={2}>
//           {questionsDB[currentQuestionIndex].options.map(
//             ({ text }: QuestionAnswerOptionT, index: number) => (

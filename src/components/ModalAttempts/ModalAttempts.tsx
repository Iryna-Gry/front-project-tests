...
import { LanguageTopicT } from 'src/types/types'
// import { NavLink } from 'react-router-dom'

const RESULT_ROOT = document.querySelector('#result-root') as HTMLDivElement

type ModalAttemptsProps = {
  onClose: () => void
  option: LanguageTopicT
}
export const ModalAttempts: React.FC<ModalAttemptsProps> = ({
  onClose,
  option,
}) => {
    ...
    <div ref={modalRef} onClick={handleBackdropClick} className={css.Overlay}>
      <div className={css.Modal}>
        ...
        <Heading
          ...
          mb='25px'
        >
          Previous {option.name} test results
        </Heading>
        <Box>

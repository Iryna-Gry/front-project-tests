...
import { CustomButton, ModalAttempts } from '../index'
import { useNavigate } from 'react-router-dom'
import { LanguageT, LanguageTopicT } from '../../types/types'

const Icons: { Fa: typeof Fa; Si: typeof Si } = {
  Fa,
  Si,
}
...
export const ListedItem: React.FC<ListedItemProps> = ({
  ...
  const [selectedOption] = useState<LanguageTopicT>(initialState)
